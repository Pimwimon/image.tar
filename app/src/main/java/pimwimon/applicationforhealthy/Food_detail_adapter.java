...
public class Food_detail_adapter extends BaseAdapter {
    public static final String TAG = Food_detail_adapter.class.getSimpleName();
    ...
    private ArrayList<Food_detail_recipe> mDataSource;


    public Food_detail_adapter(Context context, ArrayList<Food_detail_recipe> items) {
        mContext = context;
        mDataSource = items;
...
//}
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Food_detail_adapter.ViewHolder holder;
        ...
        if (convertView == null) {
            ...
            holder = new Food_detail_adapter.ViewHolder();
            ...
            holder = (Food_detail_adapter.ViewHolder) convertView.getTag();
        }
        ...
        //Get corresponding recipe for row
        Food_detail_recipe Food_detail_recipe = (Food_detail_recipe) getItem(position);

        // Update row view's textviews to display recipe information
        titleTextView.setText(Food_detail_recipe.title);
        subtitleTextView.setText(Food_detail_recipe.description);
        detailTextView.setText(Food_detail_recipe.label);

        // Use Picasso to load the image. Temporarily have a placeholder in case it's slow to load
        Picasso.with(mContext).load(Food_detail_recipe.imageUrl).placeholder(R.mipmap
                .ic_launcher).into(thumbnailImageView);
