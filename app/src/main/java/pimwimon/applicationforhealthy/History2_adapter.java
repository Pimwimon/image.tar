...
public class History2_adapter extends BaseAdapter {
    public static final String TAG = History2_adapter.class.getSimpleName();
    ...
    private ArrayList<History2_recipe> mDataSource;


    public History2_adapter(Context context, ArrayList<History2_recipe> items) {
        mContext = context;
        mDataSource = items;
...
//}
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        History2_adapter.ViewHolder holder;
        ...
        if (convertView == null) {
            ...
            holder = new History2_adapter.ViewHolder();
            ...
            holder = (History2_adapter.ViewHolder) convertView.getTag();
        }
        ...
        //Get corresponding recipe for row
        History2_recipe recipe = (History2_recipe) getItem(position);
