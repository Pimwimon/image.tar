...
public class History_adapter extends BaseAdapter {
    public static final String TAG = History_adapter.class.getSimpleName();
    ...
    private ArrayList<History_recipe> mDataSource;


    public History_adapter(Context context, ArrayList<History_recipe> items) {
        mContext = context;
        mDataSource = items;
...
//}
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        History_adapter.ViewHolder holder;
        ...
        if (convertView == null) {
            ...
            holder = new History_adapter.ViewHolder();
            ...
            holder = (History_adapter.ViewHolder) convertView.getTag();
        }
        ...
        //Get corresponding recipe for row
        History_recipe recipe = (History_recipe) getItem(position);
