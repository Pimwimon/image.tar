...
public class RecipeAdapter2 extends BaseAdapter {
    public static final String TAG = RecipeAdapter2.class.getSimpleName();
    ...
    private ArrayList<Recipe2> mDataSource;


    public RecipeAdapter2(Context context, ArrayList<Recipe2> items) {
        mContext = context;
        mDataSource = items;
...
//}
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        RecipeAdapter2.ViewHolder holder;
        ...
        if (convertView == null) {
            ...
            holder = new RecipeAdapter2.ViewHolder();
            ...
            holder = (RecipeAdapter2.ViewHolder) convertView.getTag();
        }
        ...
        //Get corresponding recipe for row
        Recipe2 recipe2 = (Recipe2) getItem(position);

        // Update row view's textviews to display recipe information
        titleTextView.setText(recipe2.title);
        subtitleTextView.setText(recipe2.description);

        Picasso.with(mContext).load(recipe2.imageUrl).placeholder(R.mipmap
                .ic_launcher).into(thumbnailImageView);
